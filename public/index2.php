...
<head>
  ...
  <title>Subins.tech - Dịch vụ mạng xã hội Instagram</title>
  <meta name="description" content="Hệ thống dịch vụ mạng xã hội Instagram" />
  <meta name="keywords" content="like, sub, share, vip like, buff mắt, tăng follow, mua like, mua sub, sub rẻ, hack like, hack sub, hack follow, tăng like, tăng follow, cách hack tăng like,share code auto like, xin code auto like, web auto like, subgiare" />
  <meta charset="UTF-8" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
  <link rel="shortcut icon" href="./src/img/logo-favicon.png" type="image/x-icon">
  <meta property="og:title" content="Subins.tech - Dịch vụ mạng xã hội Instagram" />
  <meta property="og:url" content="https://subins.tech" />
  <meta property="og:site_name" content=">Subins.tech - Dịch vụ mạng xã hội Instagram" />
...
<body>
  ...
  <div class="flex flex-col flex-1">
    <section class="mb-0" id="home">
          ...
          <div class="layout-container w-full">
            <div class="flex items-center justify-between">
              <div class="flex items-center grow basis-0 shrink-0">
                ...
                <a href="/">
                  <img alt="Logo" src="./src/img/logo-landing.png" class="logo-default h-[50px]" />
                  <img alt="Logo" src="./src/img/logo.png" class="logo-sticky hidden h-[30px] lg:h-[35px]" />
                </a>
              </div>
              ...
              <div class="grow basis-0 shrink-0 text-right ml-1">
                <a href="/Account/Login" class="btn btn-success">Đăng Nhập</a>
              </div>
              <div class="text-right ml-5 scale-[0.65]">
                <a href="#"><img src="./src/img/lang-en-index.png" /></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="relative text-[#13263c] landing-dark-color mb-10 lg:mb-20">
        ...
        <div class="grid justify-center items-center grid-cols-3 gap-5 w-full gy-10 md:mb-20">
          <div class="story mt-5">
            <div class="text-center mb-10 md:mb-0">
              <img src="./src/img/sketchy-1-2.png" class="max-h-[125px] mx-auto mb-9" alt="" />
          ...
          <div class="story mt-10">
            ...
            <div class="text-center mb-10 mb-md-0">
              <!--begin::Illustration-->
              <img src="./src/img/sketchy-1-8.png" class="max-h-[125px] mx-auto mb-9" alt="" />
              <!--end::Illustration-->
              <!--begin::Heading-->
              <div class="flex justify-center items-center mb-5">
                <!--begin::Badge-->
          ...
          <div class="story mt-10">
            ...
            <div class="text-center mb-10 mb-md-0">
              <!--begin::Illustration-->
              <img src="./src/img/sketchy-1-12.png" class="max-h-[125px] mx-auto mb-9" alt="" />
              <!--end::Illustration-->
              <!--begin::Heading-->
              <div class="flex justify-center items-center mb-5">
                <!--begin::Badge-->
        ...
        <div class="relative overflow-hidden swiper mySwiper">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide mx-16 pt-5 px-5 lg:pt-10 lg:px-10">
              <img src="./src/img/product-demos-demo3-new1.png" class="rounded-[0.475rem] max-h-full shadow-[0_0.5rem_1.5rem_0.5rem_rgb(0,0,0,0.08)]" alt="" />
            </div>
            <div class="swiper-slide mx-16 pt-5 px-5 lg:pt-10 lg:px-10">
              <img src="./src/img/product-demos-demo3-new1.png" class="rounded-[0.475rem] max-h-full shadow-[0_0.5rem_1.5rem_0.5rem_rgb(0,0,0,0.08)" alt="" />
            </div>
        ...
        <div class="layout-container">
          ...
          <div class="flex justify-center items-center">
            <div class="flex flex-wrap justify-center items-center lg:justify-between mb-15 mx-auto xl:w-[900px]">
              <div class="flex flex-col justify-center items-center h-[200px] w-[200px] lg:h-[250px] lg:w-[250px] m-3 bg-no-repeat bg-center bg-contain" style="background-image: url('./src/img/octagon.svg')">
    ...
    <section class="mt-20 -mb-20 relative z-[2]" id="testimonials">
      <div class="layout-container">
        ...
        <div class="flex justify-between items-center flex-wrap md:flex-nowrap rounded-[0.475rem] lg:-md-[3.25rem] p-8 lg:p-12 -mb-5 lg:-mb-[3.25rem] shadow-[0_0.5rem_1.5rem_0.5rem_rgb(0,0,0,0.08)]" style="background: linear-gradient(90deg, #20aa3e 0%, #03a588 100%)">
          ...
          <a href="#r" class="btn btn-lg btn-outline border-2 border-white text-white shrink-0 my-2 hover:text-[#000] hover:bg-white">Đăng ký ngay</a>
        </div>
      </div>
    </section>
    <!-- ========== End Testimonials ========== -->
            ...
            <div class="lg:pr-16 mb-10 lg:mb-0">
              <div class="rounded-[.475rem] border border-dashed border-[#2c3f5b] p-9 mb-10">
                ...
                <span class="fw-normal text-[1.25rem] text-[#5e6278]">
                  ...
                  <a href="" class="text-white opacity-50" style="
            ...
            <div class="lg:ps-16">
              <div class="flex justify-end" style="text-align: right">
                ...
                <div class="flex font-medium flex-col lg:ml-20">
                  ...
                  <a href="" class="text-white opacity-50 text-[1.15rem] mb-6" style="
                        transition: color 0.2s ease, background-color 0.2s ease;
                      ">Facebook</a>

                  <a href="https://t.me/vietotp" class="text-white opacity-50 text-[1.15rem] mb-6" style="
                        transition: color 0.2s ease, background-color 0.2s ease;
                      ">Telegram</a>
                  <a href="tel:0345005746" class="text-white opacity-50 text-[1.15rem] mb-6" style="
                        transition: color 0.2s ease, background-color 0.2s ease;
        ...
        <div class="layout-container">
          <div class="flex flex-col md:flex-row items-center justify-between py-7 lg:py-10">
            <div class="flex items-center order-2 md:order-1">
              <a href="/">
                <img alt="Logo" src="./src/img/logo-landing.png" class="h-[25px] md:h-[30px]" />
              </a>

              <span class="mx-5 text-[1.075rem] font-medium text-[#7e8299] pt-1" href="/">© 2021 Subins</span>
            </div>
